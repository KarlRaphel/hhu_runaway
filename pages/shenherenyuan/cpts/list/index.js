    ...
    methods: {
        loadData: function() {
            ...
            return new Promise(function(s, n) {
                i.setData({
                    loading: !0
                }), (0, e.Request)(0 == i.data.type ? e.Api.getShenHeBlackList : e.Api.getShenHeWhiteList, {
        ...
        submitData: function(t) {
            ...
            var s = void 0;
            s = 0 == this.data.type ? 0 == t ? e.Api.shenhe2blackList : e.Api.shenhe2whiteList : 0 == t ? e.Api.shenhe2whiteList : e.Api.shenhe2blackList, 
            (0, e.Request)(s, {
